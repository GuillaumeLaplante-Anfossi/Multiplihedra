...
\begin{remark}
\Guillaume{Robert-Nicoud-Wierstra}
\end{remark}
...
\begin{remark}
We expect an interpretation of \cref{prop:retract} in terms of Morse theory and/or discrete Morse theory. See for instance \Guillaume{Anibal, Fulton-Sturmfels, Sushmita, Thorngren}.
\end{remark}
