...
\Guillaume{Number of pairs of faces in each dimension?? $1,2,8,42,254,1678,11 790$}
...
However, as in the case of the permutahedron, this condition is not restrictive enough to determine completely the image of $\triangle_n$. For instance, in dimension $3$ it determines completely all the pairs except four of them: $\purple{\blue{abc}d} \times \red{a\red{\purple{bc}d}}$, $\purple{\blue{abc}d} \times \red{a\blue{bc}d}$, $\red{\blue{abc}d} \times \red{a\purple{bc}d}$ and $\purple{\blue{\blue{ab}c}d} \times \red{a\purple{bc}d}$.
...
For instance, the four pairs of faces above are not part of the image of the Saneblidze--Umble diagonal in dimension $3$. It would be interesting to relate more precisely the two constructions, see \cite[Remark 3.18]{LA21}.
\end{remark}
