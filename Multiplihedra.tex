...
\definecolor{Chocolat}{rgb}{0.09, 0.09, 0.7}
...
\newcommand{\brown}[1]{\textcolor{Brown}{\textbf{(}} #1 \textcolor{Brown}{\textbf{)}}} 
\newcommand{\green}[1]{\textcolor{ForestGreen}{\textbf{(}} #1 \textcolor{ForestGreen}{\textbf{)}}} 
...
\begin{remark}
F. Chapoton and V. Pilaud introduced in \cite{CP22} the shuffle of two generalized permutahedra, which is again a generalized permutahedron (see \cref{sec:generalizedpermutahedra} for definition and examples).
...
\begin{center} 
\begin{tikzcd}
\arrow[loop left,"h"] \quad \ \ \mathrm{End}(A_1) \otimes \mathrm{End}(B_1) \arrow[r, shift left, "p"] \arrow[d,"\mathrm{End}(f) \otimes \mathrm{End}(g)"]& \arrow[l,shift left,"i"] A_1 \otimes B_1 \arrow[d,"f \otimes g",dashed] \\
\arrow[loop left,"h"] \quad \ \ \mathrm{End}(A_2) \otimes \mathrm{End}(B_2) \arrow[r, shift left, "p"] & \arrow[l,shift left,"i"] A_2 \otimes B_2
\end{tikzcd}
\end{center}
