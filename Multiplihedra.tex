...
\cor{A topological map was given for the first time in} \cite{MTTV19} \cor{and was shown to recover the previous constructions at the cellular level}. 
...
\cor{Such a map was given at the level of chains in} \cite{SaneblidzeUmble04}. \cor{We provide the first topological map, which is moreover distinct from the one of} \cite{SaneblidzeUmble04} \cor{at the cellular level, see} \cref{ss:about} \cor{for more details on this point}.
