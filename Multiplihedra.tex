...
To achieve these goals, we use the theory of cellular approximations developed by the first author in \cite{LA21}, which is based on the theory of fiber polytopes \cite{BilleraSturmfels92}, and the method introduced in \cite{MTTV19}.
...
A similar phenomenon was already observed for the category of homotopy representations of an algebraic group \cite{poliakova2020cellular,AriasAbadCrainicDherin11}.
