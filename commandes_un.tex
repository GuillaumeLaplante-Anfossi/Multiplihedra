...
\newcommand{\gra}{\ell}
\newcommand{\Ainf}{\ensuremath{\mathrm{A}_\infty}} %A-infinity
...
\newcommand{\yellow}[1]{\textcolor{Dandelion}{\textbf{(}} #1 \textcolor{Dandelion}{\textbf{)}}} 
\newcommand{\green}[1]{\textcolor{ForestGreen}{\textbf{(}} #1 \textcolor{ForestGreen}{\textbf{)}}}
\newcommand{\orange}[1]{\textcolor{BurntOrange}{\textbf{(}} #1 \textcolor{BurntOrange}{\textbf{)}}} 
